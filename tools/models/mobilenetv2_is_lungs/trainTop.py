...
train_data = np.loadtxt('mobileNetV2_train_lungs.csv', delimiter=",")
...
validation_data = np.loadtxt('mobileNetV2_validation_lungs.csv', delimiter=",")
...
history = model.fit(
    ...
    callbacks=[ModelCheckpoint("mobileNetV2Top_is_lungs_{val_acc:.4f}_{val_loss:.4f}.h5", save_best_only=False, monitor='val_acc',
